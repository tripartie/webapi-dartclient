...
class ApiClient {
  ApiClient({this.basePath = 'https://platform.preprod.tripartie.com'}) {
    // Setup authentications (key: authentication name, value: authentication).
    _authentications[r'ClientIdAuth'] = ApiKeyAuth('query', 'client-id');
  }
  ...
  dynamic _deserialize(dynamic value, String targetType, {bool growable}) {
    try {
      switch (targetType) {
        ...
        case 'ModelTransactionTemplate':
          return ModelTransactionTemplate.fromJson(value);
        case 'ModelUser':
          return ModelUser.fromJson(value);
        case 'ModelWebhook':
          return ModelWebhook.fromJson(value);
        case 'RequestCreateTransactionTemplate':
          return RequestCreateTransactionTemplate.fromJson(value);
        case 'RequestRegisterUser':
          return RequestRegisterUser.fromJson(value);
        default:
          Match match;
